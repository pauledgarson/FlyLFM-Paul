...
StimResponses=cat(4,StimResponsesPut1,StimResponsesPut9,StimResponsesPut12,StimResponsesPut13);
...
title('Peak Response to Putrescine (Green, n=4)');
...
sgtitle('Response to Putrescine (Green, n=4)');
colororder(jet(12));

...
StimPeaks=cat(3,StimPeaksPut1,StimPeaksPut9,StimPeaksPut12,StimPeaksPut13);

regionslist={'OL';'CX';'LX';'LH';'PENP';'INP';'VMNP';'MB';'AL';'SNP';'VLNP';'GNG'};

FirstStimPeaks=reshape(StimPeaks(1,:,:),[12,4])';
SecondStimPeaks=reshape(StimPeaks(2,:,:),[12,4])';
ThirdStimPeaks=reshape(StimPeaks(3,:,:),[12,4])';
FourthStimPeaks=reshape(StimPeaks(4,:,:),[12,4])';
...
sgtitle('Response to Putrescine (Mated, green, n=4)');
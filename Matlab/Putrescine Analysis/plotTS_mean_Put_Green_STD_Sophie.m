%% Plots the average traces for the resposne to Putrescine for the animals of the Green Group (n=5)

% opens window to select and load multiple datasets
[file,path]=uigetfile('*.mat','Select TSROImeanTimeSeries mat-file with 12 regions','MultiSelect','on','/home/paul/Subha');
...
TimeSeriesAvg=mean(cat(3,TimeSeriesPut305,TimeSeriesPut309),3);
...
title('Average GCamp Signal (Green, n=2)');

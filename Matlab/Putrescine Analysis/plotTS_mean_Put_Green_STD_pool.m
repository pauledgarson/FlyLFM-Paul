...
TimeSeriesPaul=cat(3,TimeSeriesPut1,TimeSeriesPut5,TimeSeriesPut9,TimeSeriesPut12,TimeSeriesPut13);
TimeSeriesPaul=TimeSeriesPaul([1:3398],:,:);
TimeSeriesSophie=cat(3,TimeSeriesPut305,TimeSeriesPut309);
...
title('Median GCamp Signal (Mated, n=7)');

...
AvgResponse=mean(StimResponses_Starved(:,:,[1,2,9,10]),4);
...
legend(regionslist,'Orientation','horizontal','Location','bestoutside','fontsize',15);
...
ylabel('Mean dF/F','fontsize',15);
title('Peak Response to Taste 1st&2nd Trial (Starved)');
% 

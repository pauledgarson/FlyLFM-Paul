...
%plot description
title('Peak ON Response to Taste (Fed)');
ylabel({'Mean dF/F'});
...
%plot description
title('Peak OFF Response to Taste (Fed)');
ylabel({'Mean dF/F'});
legend([p1 p2 p3],{'Suc','Wat','Qui'},'FontSize',18);
xlim([0 13]);

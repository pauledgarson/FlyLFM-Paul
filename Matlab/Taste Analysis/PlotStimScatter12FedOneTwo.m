...
%plot description
title('Peak ON Response to Taste 1st&2nd Trial (Fed)');
ylabel({'Mean dF/F'});
...
PeaksOFF=StimPeaks_Fed([2 4 6],:,[5,6,9,10]);
...
%plot description
title('Peak OFF Response to Taste 1st&2nd Trial (Fed)');
ylabel({'Mean dF/F'});
legend([p1 p2 p3],{'Suc','Wat','Qui'},'FontSize',18);
xlim([0 13]);
ylim([0 0.05]);

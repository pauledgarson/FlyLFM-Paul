...
%plot Peaks
hold on
plot(reshape(PeaksON(1,:,:),[12 4]),'Marker','o','LineWidth',1,'LineStyle','none','Parent',axes1, 'color', 'g');
plot(reshape(PeaksON(2,:,:),[12 4]),'Marker','o','LineWidth',1,'LineStyle','none','Parent',axes1,'color', 'b');
plot(reshape(PeaksON(3,:,:),[12 4]),'Marker','o','LineWidth',1,'LineStyle','none','Parent',axes1,'color', 'r');
...
%plot description
title('Peak ON Response to Taste 1st&2nd Trial (Starved)');
ylabel({'Mean dF/F'});
...
PeaksOFF=StimPeaks_Starved([2 4 6],:,[1,2,9,10]);
...
%plot Peaks
hold on
plot(reshape(PeaksOFF(1,:,:),[12 4]),'Marker','o','LineWidth',1,'LineStyle','none','Parent',axes1, 'color', 'g');
plot(reshape(PeaksOFF(2,:,:),[12 4]),'Marker','o','LineWidth',1,'LineStyle','none','Parent',axes1,'color', 'b');
plot(reshape(PeaksOFF(3,:,:),[12 4]),'Marker','o','LineWidth',1,'LineStyle','none','Parent',axes1,'color', 'r');
...
%plot description
title('Peak OFF Response to Taste 1st&2nd Trial (Starved)');
ylabel({'Mean dF/F'});
legend([p1 p2 p3],{'Suc','Wat','Qui'},'FontSize',18);
xlim([0 13]);
